...
| File | Action |
|------|--------|
| `tests/conftest.py` | Add `superuser_headers`, `user_headers` |
| `tests/helpers.py` | Create factory functions |
| `tests/modules/orders/conftest.py` | Add `patch_dispatch`, `fresh_order`; remove duplicated fixtures |
| `tests/modules/orders/test_order_service.py` | Rewrite with fixture usage, parametrize |
| `tests/modules/orders/test_order_api.py` | Rewrite with `patch_dispatch` fixture |
| `tests/modules/products/conftest.py` | Remove duplicated fixtures |
| `tests/modules/products/test_product_service.py` | Fix imports, use helpers |
| `tests/modules/products/test_product_api.py` | Fix status code assertions |
| `tests/modules/audit/conftest.py` | Remove duplicated fixtures |
| `tests/modules/audit/test_audit_service.py` | Add type hints |
| `tests/modules/audit/test_audit_api.py` | Fix status code assertions |
| `tests/modules/roles/test_role_service.py` | Move `import uuid` to top |
| `tests/modules/roles/test_permission_service.py` | Move `import uuid` to top |
